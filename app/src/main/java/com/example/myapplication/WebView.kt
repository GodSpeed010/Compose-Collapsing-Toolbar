...
/**
 * Credit to the Accompanist Library for this file.
 * A slight modification has been made to the original code, adding a lambda parameter to the WebView Composable
 * which outputs scroll changes from the WebView.
 */
